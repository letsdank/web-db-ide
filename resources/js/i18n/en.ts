const en = {
    ...
    workspace: {
        ...
        exportingDump: 'Exporting...',
        dumpExportSuccess: 'Dump exported successfully.',
        dumpExportFailed: 'Failed to export dump.',
        dumpExportOnlyPostgres: 'Dump export is currently available only for PostgreSQL connections.',
        dumpFormat: 'Format',
        dumpFormatPlain: 'Plain SQL (.sql)',
        dumpFormatCustom: 'Custom archive (.dump)',
        dumpSection: 'Contents',
        dumpSectionFull: 'Structure + data',
        dumpSectionSchema: 'Structure only',
        dumpSectionData: 'Data only',
        dumpClean: 'Add DROP before CREATE',
        dumpIfExists: 'Use IF EXISTS',
        dumpNoOwner: 'Do not export owner',
        dumpNoPrivileges: 'Do not export privileges',
        dumpIncludeBlobs: 'Include large objects (BLOBs)',
        ...
        error: 'Error',
        rowsLabel: 'rows',
        filteredRows: 'Matched: {count}',
        sortedBy: 'sorted: {column} {direction}',
        hiddenColumnsCount: 'hidden: {count}',
        copyAll: 'Copy all',
        resetView: 'Reset view',
        export: 'Export',
        copyCell: 'Copy cell',
        copyRowAsTsv: 'Copy row as TSV',
        copyRowAsJson: 'Copy row as JSON',
        copyColumnName: 'Copy column name',
        sortAscending: 'Sort ascending',
        sortDescending: 'Sort descending',
        hideColumn: 'Hide column',
        resetHiddenColumns: 'Reset hidden columns',
        resetSorting: 'Reset sorting',
        resultsFilterPlaceholder: 'Filter: text, name:alice, is:null',
        resultsFilterHint: 'text, column:value, is:null, is:not-null',
    ...
    explorer: {
        title: 'Explorer',
        subtitle: 'Connections and database objects',
        hiddenActiveConnectionHint: 'The active connection is hidden by the current filter.',
        loadingSchemas: 'Loading schemas...',
        loadingDatabases: 'Loading databases...',
        noSchemasAvailable: 'No schemas available.',
        noDatabasesAvailable: 'No databases available.',
        noSchemasOrTablesMatchFilter: 'No schemas or tables the current filter.',
        noDatabasesOrTablesMatchFilter: 'No databases or tables match the current filter.',
        schemaLabel: 'Schema',
